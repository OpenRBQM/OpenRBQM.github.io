...
-   [Step-by-Step Guide to add a new KRI](https://gilead-biostats.github.io/gsm.kri/articles/AddingKRIs.html) outlines the necessary analytics tasks required before a new Key Risk Indicator (KRI), Quality Tolerance Limit (QTL), or similar metric can be put into production.
